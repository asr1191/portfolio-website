                    ...
                    return (
                        ...
                        >
                            <div className="grid grid-rows-2 grid-cols-steamRecentGames">
                                ...
                                <div className="col-start-2 col-end-3 row-span-2 py-1 overflow-hidden">
                                    <h1 className="text-3xl font-semibold text-ht-primary-900">{game.name}</h1>
                                    <div className="flex items-center gap-2 mt-4 mr-4 overflow-x-auto scrollbar-hide whitespace-nowrap tag-fade">
